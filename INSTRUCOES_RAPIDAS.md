...
4. Execute manualmente o workflow **Coletar DODF** e confirme que ficou verde.
5. Execute manualmente o workflow **Coletar DOU** e confirme que ficou verde.
6. No Portal RSR, em **Gerenciar Fontes**, importe `feeds.opml` para usar o feed geral recomendado. Para separar as fontes por tema, importe `feeds-tematicos.opml` no lugar dele.
